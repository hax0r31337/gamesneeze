...
namespace Config {
    ...
    inline std::unordered_map<std::string_view, ConfigItem> config{
        ...
        CONFIGITEM("Rage>RageBot>Default>Body Scale", 100),
        ...
        CONFIGITEM("Rage>RageBot>Pistol>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>Pistol>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>Pistol>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>Rifle>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>Rifle>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>Rifle>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>SMG>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>SMG>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>SMG>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>Scout>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>Scout>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>Scout>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>AWP>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>AWP>Body Scale", 100),
        CONFIGITEM("Rage>RageBot>AWP>Auto Slow", false),
        ...
        CONFIGITEM("Rage>RageBot>Heavy>Head Scale", 100),
        CONFIGITEM("Rage>RageBot>Heavy>Body Scale", 100),
        ...
        CONFIGITEM("Visuals>Players>Enemies>Dorm Box Color",
        ...
        CONFIGITEM("Visuals>Players>Enemies>Dormant", false),
        ...
        CONFIGITEM("Misc>Misc>Movement>Moon Walk", false),
