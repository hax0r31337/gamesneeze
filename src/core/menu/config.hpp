...
namespace Config {
    ...
    inline std::unordered_map<std::string_view, ConfigItem> config{
        ...
        CONFIGITEM("Legit>LegitBot>Default>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>Pistol>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>Heavy Pistol>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>Rifle>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>SMG>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>Scout>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>AWP>Smoothing", 1),
        ...
        CONFIGITEM("Legit>LegitBot>Heavy>Smoothing", 1),
        ...
        CONFIGITEM("Rage>RageBot>Default>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Default>FOV", 0),
        CONFIGITEM("Rage>RageBot>Default>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Default>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Default>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Default>Friendly Fire", false),
        ...
        CONFIGITEM("Rage>RageBot>Pistol>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Pistol>FOV", 0),
        CONFIGITEM("Rage>RageBot>Pistol>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Pistol>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Pistol>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Pistol>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>Pistol>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>Pistol>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Override", false),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>FOV", 0),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>Heavy Pistol>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>Rifle>Override", false),
        CONFIGITEM("Rage>RageBot>Rifle>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>Rifle>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Rifle>FOV", 0),
        CONFIGITEM("Rage>RageBot>Rifle>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Rifle>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Rifle>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Rifle>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>Rifle>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>Rifle>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>SMG>Override", false),
        CONFIGITEM("Rage>RageBot>SMG>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>SMG>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>SMG>FOV", 0),
        CONFIGITEM("Rage>RageBot>SMG>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>SMG>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>SMG>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>SMG>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>SMG>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>SMG>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>Scout>Override", false),
        CONFIGITEM("Rage>RageBot>Scout>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>Scout>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Scout>FOV", 0),
        CONFIGITEM("Rage>RageBot>Scout>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Scout>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Scout>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Scout>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>Scout>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>Scout>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>AWP>Override", false),
        CONFIGITEM("Rage>RageBot>AWP>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>AWP>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>AWP>FOV", 0),
        CONFIGITEM("Rage>RageBot>AWP>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>AWP>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>AWP>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>AWP>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>AWP>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>AWP>Ignore Smoke", false),
        ...
        CONFIGITEM("Rage>RageBot>Heavy>Override", false),
        CONFIGITEM("Rage>RageBot>Heavy>Hitboxes", 1),
        CONFIGITEM("Rage>RageBot>Heavy>Smoothing", 1),
        CONFIGITEM("Rage>RageBot>Heavy>FOV", 0),
        CONFIGITEM("Rage>RageBot>Heavy>Max Shot Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Heavy>Max Aim Inaccuracy", 0),
        CONFIGITEM("Rage>RageBot>Heavy>Min Damage", 1),
        CONFIGITEM("Rage>RageBot>Heavy>Friendly Fire", false),
        CONFIGITEM("Rage>RageBot>Heavy>Ignore Blind", false),
        CONFIGITEM("Rage>RageBot>Heavy>Ignore Smoke", false),
        ...
        CONFIGITEM("Visuals>Players>Enemies>Box Color",
                   ImColor(197, 66, 245, 255)),
        CONFIGITEM("Visuals>Players>Enemies>Vis Box Color",
                   ImColor(15, 0, 240, 255)),
        ...
        CONFIGITEM("Visuals>Players>Teammates>Chams>Visible Overlay Material",
                   0),
        ...
        CONFIGITEM("Visuals>Players>LocalPlayer>Weapon Overlay Color",
                   ImColor(197, 66, 245, 255)),
        CONFIGITEM("Visuals>Players>LocalPlayer>Weapon Overlay Wireframe",
                   false),
        ...
        CONFIGITEM("Visuals>Players>LocalPlayer>Sleeve Overlay Color",
                   ImColor(197, 66, 245, 255)),
        CONFIGITEM("Visuals>Players>LocalPlayer>Sleeve Overlay Wireframe",
                   false),
